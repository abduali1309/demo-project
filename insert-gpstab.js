 ...
 */
const POST_URL = 'https://app.gpstab.com/api/client/editlog/Save?driverId=106973&date=2026-05-17T00:00:00';

// Provide path to the JSON file you want to POST (absolute or relative to this script)
const JSON_FILE = path.join(__dirname, 'output', '2026-03-05-converted.json');
